...
local function tap_level( event )
	...
	storyboard.gotoScene( "lua.scenes.play", {effect="slideUp", time=400} )
end 
--------------------------------------------
...
local function make_level_button( level, stars, isLocked )
	...
	local level_back = display.newImage( sheet, 7 )
	level_back.x = 0
	level_back.y = 0
	...
	for j = 1, stars do 
		...
		local star = display.newImage( sheet, 8 )
...
function scene:createScene( event )
	...
	sheet = graphics.newImageSheet( "images/ui_default.png", sheet_options )
